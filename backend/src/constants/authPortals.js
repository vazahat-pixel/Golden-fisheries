...
export const PORTAL_ALLOWED_ROLES = {
  [AUTH_PORTALS.DRIVER]: [ROLES.DRIVER],
  [AUTH_PORTALS.BUYER]: [ROLES.BUYER],
  [AUTH_PORTALS.RESTAURANT]: [ROLES.REST_MANAGER, ROLES.REST_CASHIER, 'RESTAURANT', 'RESTAURANT_STAFF'],
  [AUTH_PORTALS.FISHMALL]: [ROLES.FISHMALL_MANAGER, ROLES.FISHMALL_CASHIER, 'FISHMALL', 'FISHMALL_BILLING']
};
