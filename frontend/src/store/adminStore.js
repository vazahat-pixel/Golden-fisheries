      ...
      fetchTrips: async () => {
        ...
        try {
          ...
          const mapped = list.map(t => ({
            ...
            driverName: t.driverName || t.driverId?.fullName || 'Driver',
            vehicle: t.vehicleNumber || t.vehicleId?.plateNumber || 'Vehicle',
            status: t.status,
            ...
            createdAt: new Date(t.createdAt).toLocaleDateString([], { month: 'short', day: 'numeric' }) + ' ' + new Date(t.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
            expenses: t.expenses || [],
            timeline: t.timeline || [],
