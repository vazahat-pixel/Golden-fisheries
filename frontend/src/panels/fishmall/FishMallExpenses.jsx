    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="bg-[#6B7550]/5 px-6 py-3 rounded-xl border border-[#6B7550]/10">
          <p className="text-[9px] font-black text-[#6B7550] uppercase tracking-[0.2em] mb-1">Today's Spend</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  type="number"
                  placeholder="0.00"
                  className="w-full bg-gray-50 border border-gray-200 pl-10 pr-4 py-3 text-[10px] font-bold outline-none focus:border-[#6B7550] rounded-xl transition-all"
            ...
            <div className="space-y-1.5">
              ...
              <textarea 
                ...
                className="w-full bg-gray-50 border border-gray-200 px-4 py-3 text-[10px] font-bold outline-none focus:border-[#6B7550] rounded-xl transition-all h-24 resize-none"
                value={formData.description}
                onChange={e => setFormData({...formData, description: e.target.value})}
              />
            </div>
            <Button type="submit" className="w-full py-4 bg-[#6B7550] hover:bg-black text-[10px] font-black uppercase tracking-widest gap-2 rounded-xl transition-all">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden flex flex-col">
          <div className="p-6 border-b border-gray-50 flex items-center justify-between">
            <h2 className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Live Expense Log</h2>
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" className="h-8 text-[8px] font-black uppercase tracking-widest rounded-lg border-gray-200">
                <Filter size={10} className="mr-1" /> All Categories
              </Button>
            </div>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50/50">
                  ...
                  <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">Description</th>
                  ...
                  <th className="px-6 py-4 text-[9px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-right">Action</th>
                </tr>
              </thead>
                  ...
                  <tr>
                    <td colSpan="5" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center opacity-20">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest">No expenses recorded yet</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                    ...
                    <tr key={expense._id || expense.id} className="hover:bg-gray-50/50 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] font-bold text-gray-600">{expense.date}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[8px] font-black uppercase tracking-widest bg-gray-100 text-gray-600">
                          {expense.category}
                        </span>
                      </td>
