...
const TapalAssignDriver = () => {
  const { harvestSlips, tapals, fetchHarvestSlips, fetchTapals, fetchVehicles, vehicles } = useAdminStore();
  ...
  useEffect(() => {
    ...
    userService
      ...
      .catch(() => setDrivers([]));
    loadPlannedTrips();
  }, [fetchHarvestSlips, fetchTapals, fetchVehicles]);
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      <label className="text-[10px] font-black uppercase text-text-muted">Vehicle (optional)</label>
                      <select
                        className="w-full border border-card-border bg-white px-3 py-2.5 text-sm mt-1"
                        value={vehicleId}
