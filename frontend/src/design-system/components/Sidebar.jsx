...
const allNavItems = [
  { icon: LayoutDashboard, label: 'Dashboard',     path: '/admin/dashboard',            roles: ['ADMIN', 'MANAGER', 'DRIVER', 'ACCOUNTANT', 'RESTAURANT_STAFF', 'FISHMALL_BILLING'] },
  { icon: Sprout,          label: 'Harvest',        path: '/admin/procurement/harvest',   roles: ['ADMIN', 'MANAGER', 'ACCOUNTANT', 'DRIVER'] },
  { icon: ClipboardList,   label: 'Tapals',         path: '/admin/tapals',               roles: ['ADMIN', 'MANAGER', 'ACCOUNTANT', 'DRIVER'] },
  { icon: ClipboardList,   label: 'Sales Approval', path: '/admin/sales-approval',       roles: ['MANAGER', 'ADMIN', 'DRIVER'] },
  { icon: Package,         label: 'Inventory',      path: '/admin/inventory',            roles: ['ADMIN', 'MANAGER', 'ACCOUNTANT', 'DRIVER'] },
  { icon: Truck,           label: 'Logistics',      path: '/admin/logistics',            roles: ['ADMIN', 'MANAGER', 'DRIVER', 'ACCOUNTANT'] },
  { icon: UserPlus,        label: 'Drivers',        path: '/admin/logistics/drivers',    roles: ['ADMIN', 'MANAGER', 'DRIVER'] },
  { icon: Truck,           label: 'Vehicle Fleet',  path: '/admin/vehicles',             roles: ['ADMIN', 'MANAGER', 'DRIVER'] },
  { icon: Store,           label: 'Outlets',        path: '/admin/outlets',              roles: ['ADMIN', 'MANAGER', 'DRIVER'] },
  { icon: IndianRupee,     label: 'Finance',        path: '/admin/finance',              roles: ['ADMIN', 'ACCOUNTANT', 'DRIVER'] },
  { icon: Receipt,         label: 'Expenses',       path: '/admin/expenses',             roles: ['ADMIN', 'MANAGER', 'ACCOUNTANT', 'DRIVER'], badge: 'expenses' },
  { icon: ReceiptText,     label: 'Billing',        path: '/admin/billing',              roles: ['ADMIN', 'ACCOUNTANT', 'DRIVER'] },
  { icon: Shield,          label: 'Access Control', path: '/admin/access',               roles: ['ADMIN', 'DRIVER'], highlight: true },
  { icon: Settings,        label: 'Settings',       path: '/admin/settings',             roles: ['ADMIN', 'DRIVER'] },
];
          ...
          {!isCollapsed && (
            <>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[8px] text-text-muted truncate uppercase tracking-widest font-black">{userRole}</p>
              </div>
